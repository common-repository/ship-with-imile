...
<?php global $woocommerce, $post; $nonce = wp_create_nonce('imile-data'); ?>

<!-- This file should primarily consist of HTML with a little bit of PHP. -->

<button class="imile_show_invoice" data-order_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr( $nonce ); ?>"><?php echo esc_html__('Download Imile Label', 'imile'); ?></button>
...
if($accessToken){
    $shipping_r = get_post_meta( $post->ID, 'imile_create_shipping_response' );
    $result = [];
    if(!empty($shipping_r)){
